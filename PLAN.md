...
- [ ] **7.3. Добавить data-атрибуты на триггеры**
    ...
    - Пример с дополнительными данными:
        ```html
        <button data-popup-id="request-call" data-popup-title="Заказать окно и модель Арктика" data-popup-product="Арктика">
        	Заказать
        </button>
        ```
...
<!-- Триггеры -->
<button data-popup-id="request-call-popup">Заказать звонок</button>

<button data-popup-id="request-call-popup" data-popup-title="Заказать окно Арктика">Заказать окно</button>
```
